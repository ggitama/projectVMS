...
const selectQuery = 'select * From vms."email_na_open"';
...
const agreement_code = result.rows[0].agreement_code;
...
const mailOptions = {   
  ...
  cc: 'chindylestari69@gmail.com',
  subject: 'VMS New Agreement '+agreement_code+ ' DI TERIMA ',
...
transporter.sendMail(mailOptions, (error, info) => {
  if (error) {
    ...
    if(info.response =='250 Mail queued for delivery'){ 
        ...
        const insertquery = `insert into vms."log_email_na_open" 
        values ('${id}','${agreement_code}','${textemail}');`
